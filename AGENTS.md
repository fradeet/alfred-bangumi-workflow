...
- Keep reusable Alfred response value objects in `workflow/src/AlfredAdapter/Types/` and the `Alfred\Workflow\AlfredAdapter\Types` namespace, and follow PSR-4: each class name must match its filename.
